function es({ deck: e, cards: t, isParentMode: isParent, onBack: n, onStudy: r, onNewCard: a, onEditCard: l, onDeleteCard: i }) {
  ...
  return (0, u.jsxs)("div", {
    ...
    children: [
      (0, u.jsx)("button", {
        onClick: n,
        className: "tap-min font-body text-sm text-ink-soft hover:text-ink mb-6 transition-colors self-start flex items-center gap-1.5",
        ...
        children: [
          ...
          (0, u.jsxs)("button", {
            ...
            children: [
              ...
              0 === o ? " Sem palavras para hoje" : " Começar leitura (" + o + ")"
            ]
          })
        ]
      }),
      (0, u.jsxs)("div", {
        ...
        children: [
          (0, u.jsxs)("p", { className: "font-body text-sm text-ink-soft", children: [t.length, " ", 1 === t.length ? "palavra" : "palavras"] }),
          isParent ? (0, u.jsx)("button", {
            onClick: a,
            className: "tap-min font-body text-sm font-medium rounded-full bg-base-raised px-4 text-white hover:bg-base-strong transition-colors flex items-center gap-1.5",
          ...
          return (0, u.jsxs)("li", {
            ...
            children: [
              ...
              (0, u.jsxs)("div", {
                ...
                children: [
                  X(e) ? (0, u.jsx)("span", { className: "font-body text-xs font-semibold rounded-full status-due px-3 py-1", children: "para hoje" }) : (0, u.jsx)("span", { className: "font-body text-xs font-semibold rounded-full status-ok px-3 py-1", children: "em dia" }),
                  isParent ? (0, u.jsxs)("div", {
                    className: "flex gap-2 items-center",
                    children: [
                      (0, u.jsx)("span", { className: "font-body text-xs " + eo[t], children: ei[t] }),
                      (0, u.jsx)("button", {
                        type: "button",
                        onClick: () => l(e),
                        className: "tap-min font-body text-sm px-3 rounded-full bg-base-raised text-white",
                        children: "editar"
                      }),
                      (0, u.jsx)("button", {
                        type: "button",
                        onClick: () => i(e.id),
                        className: "tap-min font-body text-sm px-3 rounded-full bg-coral-dim text-coral",
                        children: "excluir"
                      })
                    ]
                  }) : null
